...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-gray-800">
      {/* Main Two-Column Layout with Single Background */}
      <div
        className="flex-grow grid grid-cols-[3fr_1fr] min-h-screen gap-0 bg-no-repeat bg-center bg-cover relative"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-right  p-6">
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1.1 }}
            transition={{ duration: 0.8 }}
            className="bg-opacity-90 p-8 rounded-lg shadow-lg max-w-xl w-11/12"
          >
            <h2 className="text-4xl font-bold text-white mb-4">
              GeoFence Tracker
            </h2>
            <p className="text-gray-400 text-xl leading-relaxed">
              Our GeoFence application provides powerful location tracking in
              real-time, enabling you to define boundaries and receive instant
              alerts when a tracked device enters or leaves. Whether for
              business logistics, security, or personal use, GeoFence offers
              unmatched control and safety.
            </p>
          </motion.div>
        </div>
